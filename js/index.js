	...
	function (toMsg, model, index, letter) {
		if (letter.$ === 'Boundary') {
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('puzzle-letter puzzle-letter-boundary')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
			...
			return _Utils_eq(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('puzzle-letter puzzle-letter-interior puzzle-letter-selected'),
						$elm$html$Html$Events$onClick(
						A2($elm$core$Basics$composeL, toMsg, $author$project$Puzzle$LetterClicked)(index))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('puzzle-letter puzzle-letter-interior '),
						$elm$html$Html$Events$onClick(
						A2($elm$core$Basics$composeL, toMsg, $author$project$Puzzle$LetterClicked)(index))
					]),
				_List_fromArray(
...
var $author$project$Puzzle$viewLetters = F2(
	function (toMsg, model) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('puzzle-letters')
				]),
			A2(
				$elm$core$List$indexedMap,
